...
const Index = () => {
  ...
  // Rainbow Carrots
  sellers[1].products[1],
  // Microgreens Mix
  sellers[2].products[0],
  // Strawberries
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center rounded-lg">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <Button size="lg" variant="outline" className="border-green-DEFAULT hover:bg-green-lighter text-red-500">
                Become a Seller
              </Button>
            </div>
          </div>
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div>
              {selectedSeller ? <SellerProfile seller={selectedSeller} /> : <div className="bg-white rounded-lg shadow-lg p-6 h-full flex flex-col justify-center items-center text-center">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredProducts.slice(0, 4).map(product => <ProductCard key={product.id} product={{
            ...product,
            seller: sellers.find(s => s.products.some(p => p.id === product.id))?.name
          }} />)}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex">
                <input type="email" placeholder="Your email" className="px-3 py-2 rounded-l-md text-green-DEFAULT w-full focus:outline-none" />
